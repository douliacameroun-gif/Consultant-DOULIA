              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-left">
                <div className="flex flex-col">
                  ...
                  <button 
                    ...
                    className="mt-auto text-xs font-bold text-doulia-lime border border-doulia-lime/30 px-4 py-2.5 rounded-xl hover:bg-doulia-lime hover:text-doulia-night transition-all flex items-center justify-center gap-2 group/btn"
                  >
                    Réserver mon Audit
